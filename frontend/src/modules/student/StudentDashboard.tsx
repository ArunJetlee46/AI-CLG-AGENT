    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        {[
          ...
          { to: "/student/schedule", label: "My Schedule", sub: "Weekly timetable", icon: CalendarClock, accent: "text-indigo-600 bg-indigo-100" },
          { to: "/student/placements", label: "My Placements", sub: "Readiness · shortlists", icon: Handshake, accent: "text-emerald-600 bg-emerald-100" },
          { to: "/student/study-assist", label: "Study Assistant", sub: "Curriculum Q&A", icon: MessagesSquare, accent: "text-teal-600 bg-teal-100" },
